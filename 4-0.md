...
1. The image shown in Figure 1, is from the drone R&D document titled, *"Optimized Planning and Tasking for the Intelligent Management of Unmanned Aerial Vehicles"* (which is included in the zip folder). 
    ...
    1. Figure 1 illustrates the internal workings of the AI (the neural network and software program) that operates drones. It also demonstrates the thought process and rationales of R&D engineers who come up with "objective cost functions," for evaluating the value of kills performed by automated war-machines. 
       ...
       1. Such a cost to the military in successfully attacking a target using pre-programmed drones, as shown in this particular example, was labeled as *Quality of target nomination (Q).*
        ...
        1. Q was calculated as the algebraic sum of the above two mathematical terms in terms of numerical points, for driving the neural network algorithms of the drones' AI.

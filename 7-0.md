...
To analyze a physical-memory-dump of things like time and location data from wearable devices, one can use the following category of tools, along with their appropriate workflow involving sensitive, statistical techniques. 
...
Higher quality judiciaries typically search for a "permutation" of physically measurable constructs such as time, location, method of entry into an area, method of use of particular artifacts, and extent of damages or injuries thus caused. A one of a kind permutation, that ties measurable constructs in a tangible and precise way, is labeled as "facts of a case." But most crucially, such facts need to be *palpable* to the culturally driven sense and sensibilities, of the more influential people associated with the case, in a personalized manner. 

As a generalization, lawyers are practically hackers, whose job when defending against any presented evidence is to, at least, make the facts of the case seem like a "combination" of happenstance, people, places, physical artifacts, and so-called resultant damages. When factual items can be shown as a mere combination of things, instead of a permutation, the defense lawyers can argue that there exists "room for doubt," within the physical ways in which the given pieces of evidence, and testimony, could combine to produce a variety of results, that wouldn't <ins>necessarily</ins> produce the stated forms of harms, injuries, or damages. Apart from sowing seeds of doubt into the adjudicating process, a lawyer typically finds ways to minimize, undermine and undercut: 

1. The internal validity of the opposing team's presentations and presenters. That is, the consistency of what was being provided and by whom. 

1. As well as the external validity of the opposing team's presentation. That is, the applicability of the given facts in other similar cases, due to precedence, or standard of admissibility set forth by other 'laudable' cases known to, and followed by, the authorities of the particular jurisdiction where the case is being argued.  

If all tried and tested methods of weakening the opposition, including "gray-area" strategies and tactics fail, the lawyer's next task is to bargain and negotiate the eventual terms related to the fines, penalties, and any other form of remedies or punitive damages, that need to be put into effect by one of the parties, in favor of the other. Of course, lawyers and judges along with other members of the legal industry, tend to apply multi-pronged strategies, and tactics, to steer a case towards an outcome that is inline with the philosophical sense, and style of fairness, political correctness, and ethical as well as moral rectitude, which they have come to imbibe and believe in, via their education, specialization, and experiences, to be maximally adhered to, as, "the best form of practice in most given cases."  

An adjudicator can most certainly, choose to take the circumstantial as well as "hard pieces of evidence" pertaining to the case, into consideration. To consequently decide that even in a combined form, rather than a permuted form, the discovered materials of the case were sufficiently well-established, in order to formally conclude that the points of conflict being adjudicated, were indeed causally produced from the presented assumptions, premises, and investigated facts. Upon making such a decision involving the adjudicators personal sense of sufficiency, wisdom and fair-mindedness, the judgment delivered by the adjudication process typically has hedged sentences and phrases like, "the case was proven beyond a measure of 'reasonable' doubt." 

The level of physical quality, and that of care and attention used in conducting measurements, as well as the approach to proving results from investigations, presented using different types of rhyme and reason, are guaranteed to be idiosyncratic to the cultural environment of, and limited to the cultural cordons of, the adjudicating organization's participating members.  

Whether the judgment provided by a judiciary process were correct or erroneous, is a question left to the next group of people, who might be motivated to jostle with the particulars of a given case, which was already decided upon by a lower tier court. This aspect of the legal industry has allowed "attrition" based defense strategies to become popular among the industry's members. The direct negative consequence of using stall tactics, is the incremental erosion of public trust, and belief, invested by common people, in the concept of being treated in an equitable manner, by the overall judiciary system acting upon them.  

Due to the above-mentioned systemic challenges of judiciaries in various countries, the eventual conclusion is to hire a good lawyer who knows the law of the land, if one can afford to do so. Better yet, retain a team of lawyers who *know* how to manipulate the judges of the land, if one can afford to do so. 

Which then begs the question? What is to be done when an escalating serious conflict at hand, is of an international nature, with a number of defining characteristics and components, that all together reside squarely outside the bounds of existing legal statutes, of known national level judiciary systems?  

This is where I'd like to segue into the next section to discuss the topic of, **"Blue Sky Projects,"** and how they relate to the materials being provided here, in this repository, especially in the context of *Zero-Day Faults* that impact the aviation industry at an international-level. The next section also discusses some of the ways in which *Zero-Day Hacks* are continuously generated by state-sponsored *Red Teams,* against targeted peoples. The following section has been provided in this repository, with the aim that such knowledge can help conscientious SysAdmins mitigate, and appropriately defend against, those kinds of incorrigible hacks. 
